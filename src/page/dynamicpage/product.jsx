      ...
      <div className="mt-10 grid grid-cols-2 gap-6 lg:mt-16 lg:grid-cols-4 lg:gap-4">
        <article className="relative">
          <div className="aspect-square overflow-hidden">
            <img
              ...
              src="https://media.istockphoto.com/id/1449334081/photo/statue-of-lady-justice-on-desk-of-a-judge-or-lawyer.webp?b=1&s=170667a&w=0&k=20&c=n9t9_CK0-gpYpCjO5tEN-a5vRV0fbhyjnAy4iprc2UI="
              alt=""
            />
          </div>
        ...
        <article className="relative">
          <div className="aspect-square overflow-hidden">
            <img
              className="group-hover:scale-125 h-full w-full object-cover transition-all duration-300"
              src="https://media.istockphoto.com/id/1440541516/photo/open-book-in-hardcover-on-a-white-background.webp?b=1&s=170667a&w=0&k=20&c=5lOgqBkmKE0xrpd5LvFfV78aStkswFmjJe-TNuK91Z0="
              alt=""
            />
          </div>
          <div className="mt-4 flex items-start justify-between">
        ...
        <article className="relative">
          <div className="aspect-square overflow-hidden">
            <img
              className="group-hover:scale-125 h-full w-full object-cover transition-all duration-300"
              src="https://media.istockphoto.com/id/1495321240/photo/redhead-female-student-reading-a-book-in-library.jpg?s=1024x1024&w=is&k=20&c=JW9zcez22IcbxmMbtFiHWVXKRApUbcWGFrVdv_eICAs="
              alt=""
            />
          </div>
          <div className="mt-4 flex items-start justify-between">
